...
class _$_SignUpState implements _SignUpState {
  const _$_SignUpState(
      {this.isSignUp = const AsyncValue<bool>.data(false),
  ...
  @override
  String toString() {
    return 'SignUpState(isSignUp: $isSignUp, isLoading: $isLoading, isObscure: $isObscure, isTermsAndCondition: $isTermsAndCondition, formData: $formData)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isSignUp, isLoading, isObscure,
      isTermsAndCondition, const DeepCollectionEquality().hash(_formData));
...
abstract class _SignUpState implements SignUpState {
  const factory _SignUpState(
      ...
      final bool isObscure,
      final bool isTermsAndCondition,
      final Map<String, dynamic> formData}) = _$_SignUpState;
